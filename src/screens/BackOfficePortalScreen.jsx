...
.admin-shell{display:grid;grid-template-columns:280px minmax(0,1fr);grid-template-rows:auto minmax(0,1fr);min-height:100%;width:100%;overflow:visible}
...
.sidebar{position:sticky;top:88px;grid-column:1;grid-row:2;height:calc(var(--app-vh,100vh) - 88px);display:grid;grid-template-rows:minmax(0,1fr) auto;gap:16px;padding:24px;background:linear-gradient(135deg,#0f3b8f 0%,#1d4ed8 54%,#38bdf8 100%);color:#eef5ff;overflow:hidden}.sidebar.is-closed{display:none}
.nav-list{display:grid;gap:22px;min-height:0;overflow-y:auto;padding-right:2px}.nav-group{display:grid;gap:6px}.nav-group-label{margin:0 0 2px;color:rgba(255,255,255,.78);font-size:11px;letter-spacing:.02em;text-transform:uppercase}.nav-item,.sidebar-logout{display:grid;grid-template-columns:24px minmax(0,1fr);align-items:center;gap:12px;min-height:44px;border-radius:8px;color:#eef6ff;padding:0 14px;font-weight:600;opacity:1}.nav-item span,.sidebar-logout span{color:inherit;opacity:1}.nav-item svg,.sidebar-logout svg{color:inherit;opacity:1;stroke-width:2.2}.nav-item:hover,.nav-item[aria-current=page]{background:rgba(255,255,255,.18);box-shadow:inset 0 0 0 1px rgba(255,255,255,.24);color:#fff}.sidebar-logout{width:100%;border:1px solid rgba(255,255,255,.28);background:rgba(255,255,255,.14);color:#fff;text-align:left}
.admin-main{grid-column:2;grid-row:2;min-width:0;min-height:0;overflow:visible}.content-area{min-height:calc(var(--app-vh,100vh) - 88px);padding:34px 28px 28px;background:#f5f7fb;overflow:visible}.page-stack{display:grid;gap:22px}.page-header{display:flex;align-items:flex-end;justify-content:space-between;gap:16px}.page-header h2{margin:0;font-size:30px;line-height:1.15;font-weight:500}.page-header p{max-width:760px;margin:8px 0 0;color:#66736f}.eyebrow{margin:0;color:#1d4ed8;font-size:12px;font-weight:600;letter-spacing:0;text-transform:uppercase}
...
.table-wrap{overflow-x:auto;border:1px solid #dce5e2;border-radius:8px;background:#fff}.data-table{width:100%;min-width:760px;border-collapse:collapse}.data-table th,.data-table td{border-bottom:1px solid #dce5e2;padding:13px 14px;text-align:left;vertical-align:middle}.data-table th{background:#f8fafc;color:#47514f;font-size:12px;font-weight:600;text-transform:uppercase}.status-badge{display:inline-flex;min-height:28px;align-items:center;border-radius:999px;padding:0 10px;background:rgba(29,78,216,.12);color:#1d4ed8;font-size:12px;font-weight:500;text-transform:capitalize;white-space:nowrap}.button,.table-actions button{display:inline-flex;align-items:center;justify-content:center;gap:8px;min-height:38px;border:1px solid transparent;border-radius:8px;padding:0 14px;font-weight:500}.button.primary{background:linear-gradient(135deg,#0f3b8f 0%,#1d4ed8 54%,#38bdf8 100%);color:#fff}.button.secondary{border-color:#dce5e2;background:#fff;color:#16211f}
