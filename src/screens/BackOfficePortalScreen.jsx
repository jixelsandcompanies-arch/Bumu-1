...
.nav-list{display:grid;gap:22px;min-height:0;overflow-y:auto;padding-right:2px}.nav-group{display:grid;gap:6px}.nav-group-label{margin:0 0 2px;color:rgba(255,255,255,.68);font-size:11px;letter-spacing:.02em;text-transform:uppercase}.nav-item,.sidebar-logout{display:grid;grid-template-columns:24px minmax(0,1fr);align-items:center;gap:12px;min-height:44px;border-radius:8px;color:rgba(255,255,255,.9);padding:0 14px;font-weight:500}.nav-item:hover,.nav-item[aria-current=page]{background:rgba(255,255,255,.18);box-shadow:inset 0 0 0 1px rgba(255,255,255,.24);color:#fff}.sidebar-logout{width:100%;border:1px solid rgba(255,255,255,.24);background:rgba(255,255,255,.12);color:#fff;text-align:left}
