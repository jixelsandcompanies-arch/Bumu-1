...
const styles = StyleSheet.create({
  ...
  authRoot: { minHeight: 'var(--app-vh)', width: '100%', backgroundColor: 'var(--app-bg)', overflowY: 'auto' },
  authContent: { minHeight: 'var(--app-vh)', alignItems: 'center', justifyContent: 'flex-start', padding: 12, paddingTop: 18, paddingBottom: 28 },
